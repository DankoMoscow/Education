...
Tcr_co2 = 304.12
print('Молярынй объём ИПС при ноормальной температуре кипения ', ips_volume_norm, '\n''Молярынй объём CO2 при ноормальной температуре кипения', co2_volume_norm)



nu_ips = (8.0765e-9 + 8.9165e-6 * P)/(-2.8943e13 + 8.9749e10 * T + 2.3002e5 * T**3 + P/10) #динамический коэф вязкости ипс TODO непонятно, нужно ли давление на 100000 умножать
...
diff_coef_co2 = 8.93 * 1e-12 *(co2_volume_norm / ips_volume_norm**2)**(1 / 6) * (Par_ips / Par_co2)**0.6 * T / nu_ips   #коэфф диффузии co2 in ips

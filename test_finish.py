...
#TODO доп параметры хер знает зачем, хер знает почему, но да ладно/ необходимо сделать так, чтобы при нажатии вкладки доп параметров сворачивалась вкладка с основными и переходила на доп и обратно, с полным сохранением всех value
'''
таким образом диалоговое окно будет меньше по размеру и удобнее
'''
